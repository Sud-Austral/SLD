...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:se="http://www.opengis.net/se" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1.0" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
                 <se:Rule>
          <se:Name>824.0 - 952.2</se:Name>
          <se:Description>
            <se:Title>824.0 - 952.2</se:Title>
          </se:Description>
        ...
        <se:Rule>
          <se:Name>952.2 - 1080.4</se:Name>
          <se:Description>
            <se:Title>952.2 - 1080.4</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
        ...
        <se:Rule>
          <se:Name>1080.4 - 1208.6000000000001</se:Name>
          <se:Description>
            <se:Title>1080.4 - 1208.6000000000001</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
              ...
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>Annual precipitation mm</ogc:PropertyName>
                <ogc:Literal>1208.6000000000001</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <se:PolygonSymbolizer>
        ...
        <se:Rule>
          <se:Name>1208.6000000000001 - 1336.8000000000002</se:Name>
          <se:Description>
            <se:Title>1208.6000000000001 - 1336.8000000000002</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
              ...
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>Annual precipitation mm</ogc:PropertyName>
                <ogc:Literal>1336.8000000000002</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <se:PolygonSymbolizer>
        ...
        <se:Rule>
          <se:Name>1336.8000000000002 - 1465.0</se:Name>
          <se:Description>
            <se:Title>1336.8000000000002 - 1465.0</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
