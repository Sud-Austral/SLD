  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
                ...
                <se:Rule>
          <se:Name>0.0 - 0.02</se:Name>
          <se:Description>
            <se:Title>0.0 - 0.02</se:Title>
          </se:Description>
        ...
        <se:Rule>
          <se:Name>0.04 - 0.06</se:Name>
          <se:Description>
            <se:Title>0.04 - 0.06</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
        ...
        <se:Rule>
          <se:Name>0.06 - 0.08</se:Name>
          <se:Description>
            <se:Title>0.06 - 0.08</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
        ...
        <se:Rule>
          <se:Name>0.08 - 0.1</se:Name>
          <se:Description>
            <se:Title>0.08 - 0.1</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
