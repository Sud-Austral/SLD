...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:se="http://www.opengis.net/se" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1.0" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
                 <se:Rule>
          <se:Name>5.1 - 6.779999999999999</se:Name>
          <se:Description>
            <se:Title>5.1 - 6.779999999999999</se:Title>
          </se:Description>
        ...
        <se:Rule>
          <se:Name>6.779999999999999 - 8.459999999999999</se:Name>
          <se:Description>
            <se:Title>6.779999999999999 - 8.459999999999999</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
        ...
        <se:Rule>
          <se:Name>8.459999999999999 - 10.139999999999999</se:Name>
          <se:Description>
            <se:Title>8.459999999999999 - 10.139999999999999</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
        ...
        <se:Rule>
          <se:Name>10.139999999999999 - 11.819999999999999</se:Name>
          <se:Description>
            <se:Title>10.139999999999999 - 11.819999999999999</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
        ...
        <se:Rule>
          <se:Name>11.819999999999999 - 13.5</se:Name>
          <se:Description>
            <se:Title>11.819999999999999 - 13.5</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
