...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:se="http://www.opengis.net/se" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1.0" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
                 <se:Rule>
          <se:Name>-10.8 - -5.300000000000001</se:Name>
          <se:Description>
            <se:Title>-10.8 - -5.300000000000001</se:Title>
          </se:Description>
        ...
        <se:Rule>
          <se:Name>-5.300000000000001 - 0.1999999999999993</se:Name>
          <se:Description>
            <se:Title>-5.300000000000001 - 0.1999999999999993</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
              ...
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>Mean temperature of coldest quarter C</ogc:PropertyName>
                <ogc:Literal>0.1999999999999993</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <se:PolygonSymbolizer>
        ...
        <se:Rule>
          <se:Name>0.1999999999999993 - 5.699999999999999</se:Name>
          <se:Description>
            <se:Title>0.1999999999999993 - 5.699999999999999</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
        ...
        <se:Rule>
          <se:Name>5.699999999999999 - 11.2</se:Name>
          <se:Description>
            <se:Title>5.699999999999999 - 11.2</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
        ...
        <se:Rule>
          <se:Name>11.2 - 16.7</se:Name>
          <se:Description>
            <se:Title>11.2 - 16.7</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
